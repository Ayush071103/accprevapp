...
class MQ4Page extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _MQ4PageState();
  }
}

class _MQ4PageState extends State<MQ4Page> {
  String? data;
  var all_data;
  ...
  void getData() async {
    ...
    http.Response response = await http
        .get(Uri.parse("https://accprevapp.000webhostapp.com/API/fetch_mq4gas_sensor.php"));
                  ...
                  Padding(padding: EdgeInsets.only(left: 16,right: 16,top: 8,bottom: 24),
                    child: Row(
                      children: [
                        ...
                        Text(jsonDecode(data!)['data'][index]['mq4_value'],
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal))
                      ],
                    ),
                  ),
