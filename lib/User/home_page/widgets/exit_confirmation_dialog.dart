    ...
    child: Column(
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text('Are You Sure want to Logout?', style: TextStyle(fontSize: 18, color:Color(0xFF032737), fontWeight: FontWeight.bold),),
        ),
        SizedBox(height: 24,),
        Row(
          ...
          children: <Widget>[
            ElevatedButton(
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(Color(0xFF032737)),
              ),
              onPressed: () async {
